...
void TestDistribution()
{
    ...
    //
    // ÐµÑÐ»Ð¸ Ð¿Ð¾Ð´ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð²Ð¼ÐµÑÑ‚Ð¾ ++buckets[hasher(point) % num_buckets]
    // Ð²Ñ‹Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ ++buckets[dist(gen) % num_buckets], Ñ‚Ð¾ Ñ Ð²ÐµÑ€Ð¾ÑÑ‚Ð½Ð¾ÑÑ‚ÑŒÑŽ 95%
